...
(function ($, undef) {
  ...
  function numeric(mixed) {
    return (
      (isNumber(mixed) || isString(mixed)) && mixed !== "" && !isNaN(mixed)
    );
  }
      ...
      if (cache) {
        ...
        geocoder().geocode(conf, function (results, status) {
          if (status === gm.GeocoderStatus.OK) {
            ...
            status === gm.GeocoderStatus.OVER_QUERY_LIMIT &&
            attempt < defaults.queryLimit.attempt
          ) {
            setTimeout(function () {
              resolveLatLng.apply(self, [
                ctx,
                method,
                runLatLng,
                args,
              ...
              Math.floor(Math.random() * defaults.queryLimit.random));
          } else {
  ...
  function InternalClusterer($container, map, raw) {
    ...
    function extendsBounds(latLng) {
      var p = projection.fromLatLngToDivPixel(latLng),
        ne = projection.fromDivPixelToLatLng(
          new gm.Point(p.x + raw.radius, p.y - raw.radius)
        ),
    ...
    function redraw() {
      ...
      for (i = 0; i < tds.length; i++) {
        if (
          tds[i] &&
          (!check || bounds.contains(tds[i].options.position)) &&
          (!ffilter || ffilter(values[i]))
        ) {
          keys.push(i);
        }
      }
  ...
  function Gmap3($this) {
    ...
    function createClusterer(raw) {
      ...
      internalClusterer.display(function (cluster) {
        ...
        if (style) {
          ...
          obj = self.overlay(
            { td: atd, opts: atd.options, latLng: toLatLng(cluster) },
            true
          );

          atd.options.pane = "floatShadow";
          atd.options.content = $(document.createElement("div"))
          ...
          attachEvents($this, { td: td }, shadow, undef, {
            main: obj,
            shadow: shadow,
          });
    ...
    self.marker = function (args) {
      ...
      if (args.td.cluster) {
        ...
        $.each(args.td.values, function (i, value) {
          ...
          td.options.position = td.options.position
            ? toLatLng(td.options.position)
            : toLatLng(value);
    ...
    self.getroute = function (args) {
      ...
      directionsService().route(args.opts, function (results, status) {
        callback(
          args,
          status === gm.DirectionsStatus.OK ? results : false,
          status
        );
        task.ack();
      });
    ...
    self.getdistance = function (args) {
      ...
      distanceMatrixService().getDistanceMatrix(
        ...
        function (results, status) {
          callback(
            args,
            status === gm.DistanceMatrixStatus.OK ? results : false,
            status
          );
          task.ack();
        }
    ...
    self.circle = function (args) {
      ...
      $.each(args.td.values, function (i, value) {
        var id,
          obj,
          td = tuple(args, value);
        td.options.center = td.options.center
          ? toLatLng(td.options.center)
          : toLatLng(value);
        if (!map) {
    ...
    self.getmaxzoom = function (args) {
      maxZoomService().getMaxZoomAtLatLng(args.latLng, function (result) {
        callback(
          args,
          result.status === gm.MaxZoomStatus.OK ? result.zoom : false,
          status
        );
        task.ack();
      });
    ...
    self.getelevation = function (args) {
      var i,
        ...
        f = function (results, status) {
          callback(
            args,
            status === gm.ElevationStatus.OK ? results : false,
            status
          );
          task.ack();
        };
      ...
      if (locations.length) {
        ...
        if (locations.length) {
          elevationService().getElevationAlongPath(
            { path: locations, samples: args.td.samples },
            f
          );
        } else {
          task.ack();
    ...
    self.rectangle = function (args) {
      ...
      $.each(args.td.values, function (i, value) {
        var id,
          obj,
          td = tuple(args, value);
        td.options.bounds = td.options.bounds
          ? toLatLngBounds(td.options.bounds)
      ...
      $.each(array(args.td.func), function (i, func) {
        $.each(
          self.get(
            args.td,
            true,
            args.td.hasOwnProperty("full") ? args.td.full : true
          ),
          function (j, res) {
            func.call($this, res);
          }
  ...
  Superslides = function (el, options) {
    ...
    var pagination = {
      ...
      _events: function () {
        that.$el.on(
          "click",
          that.options.elements.pagination + " a",
          function (e) {
            e.preventDefault();
...
/******/ (function (modules) {
  ...
  /******/ [
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      "use strict";
      __webpack_require__.r(__webpack_exports__);
      /* harmony import */ var video_worker__WEBPACK_IMPORTED_MODULE_0__ =
      ...
      /* harmony import */ var lite_ready__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(2);
      /* harmony import */ var lite_ready__WEBPACK_IMPORTED_MODULE_2___default =
        /*#__PURE__*/ __webpack_require__.n(
          lite_ready__WEBPACK_IMPORTED_MODULE_2__
        );
      /* harmony import */ var _jarallax_video_esm__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(9);

      // add video worker globally to fallback jarallax < 1.10 versions

      global__WEBPACK_IMPORTED_MODULE_1___default.a.VideoWorker =
        global__WEBPACK_IMPORTED_MODULE_1___default.a.VideoWorker ||
        video_worker__WEBPACK_IMPORTED_MODULE_0__["default"];
      ...
      lite_ready__WEBPACK_IMPORTED_MODULE_2___default()(function () {
        if (
          "undefined" !==
          typeof global__WEBPACK_IMPORTED_MODULE_1___default.a.jarallax
        ) {
        ...
        _createClass(VideoWorker, [
          ...
          },
          {
            ...
            value: function fire(name) {
              ...
              if (
                this.userEventsList &&
                "undefined" !== typeof this.userEventsList[name]
              ) {
          ...
          },
          {
            ...
            value: function play(start) {
              ...
              if ("youtube" === self.type && self.player.playVideo) {
                ...
                if (
                  global__WEBPACK_IMPORTED_MODULE_0___default.a.YT.PlayerState
                    .PLAYING !== self.player.getPlayerState()
                ) {
              ...
              if ("youtube" === self.type) {
                ...
                tempImg.onload = function () {
                  ...
                  if (
                    ...
                    // ok
                    self.videoImage = "https://img.youtube.com/vi/"
                      .concat(self.videoID, "/")
                      .concat(availableSizes[step], ".jpg");
                    callback(self.videoImage);
                  } else {
                    // try another size
                    step += 1;
                ...
                tempImg.src = "https://img.youtube.com/vi/"
                  .concat(self.videoID, "/")
                  .concat(availableSizes[step], ".jpg");
              }
            ...
            value: function getVideo(callback) {
              ...
              self.onAPIready(function () {
                ...
                if ("youtube" === self.type) {
                  ...
                  self.playerOptions.events = {
                    ...
                    onStateChange: function onStateChange(e) {
                      ...
                      if (
                        self.options.loop &&
                        e.data ===
                          global__WEBPACK_IMPORTED_MODULE_0___default.a.YT
                            .PlayerState.ENDED
                      ) {
                        self.play(self.options.startTime);
                      }
                  ...
                  self.player =
                    self.player ||
                    new global__WEBPACK_IMPORTED_MODULE_0___default.a.YT.Player(
                      self.playerID,
                      self.playerOptions
                    );
                ...
                if ("vimeo" === self.type) {
                  ...
                  if (!self.$video) {
                    ...
                    Object.keys(self.playerOptions).forEach(function (key) {
                      ...
                      playerOptionsString += ""
                        .concat(key, "=")
                        .concat(encodeURIComponent(self.playerOptions[key]));
                  ...
                  self.player =
                    self.player ||
                    new global__WEBPACK_IMPORTED_MODULE_0___default.a.Vimeo.Player(
                      self.$video,
                      self.playerOptions
          ...
          },
          {
            ...
            value: function loadAPI() {
              ...
              if ("vimeo" === self.type && !VimeoAPIadded) {
                ...
                if (
                  "undefined" !==
                  typeof global__WEBPACK_IMPORTED_MODULE_0___default.a.Vimeo
                ) {
                  return;
                }
          ...
          },
          {
            ...
            value: function onAPIready(callback) {
              ...
              if ("youtube" === self.type) {
                ...
                if (
                  ("undefined" ===
                    typeof global__WEBPACK_IMPORTED_MODULE_0___default.a.YT ||
                    0 ===
                      global__WEBPACK_IMPORTED_MODULE_0___default.a.YT
                        .loaded) &&
                  ...
                  "object" ===
                    _typeof(global__WEBPACK_IMPORTED_MODULE_0___default.a.YT) &&
                  1 === global__WEBPACK_IMPORTED_MODULE_0___default.a.YT.loaded
                ) {
                  callback();
                } else {
              ...
              if ("vimeo" === self.type) {
                if (
                  "undefined" ===
                    typeof global__WEBPACK_IMPORTED_MODULE_0___default.a
                      .Vimeo &&
                  !loadingVimeoPlayer
                ) {
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      function jarallaxVideo() {
        ...
        Jarallax.prototype.canInitParallax = function () {
          ...
          var video = new video_worker__WEBPACK_IMPORTED_MODULE_0__["default"](
            self.options.videoSrc,
            {
              autoplay: true,
